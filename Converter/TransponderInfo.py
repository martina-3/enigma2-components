        ...
        if transponderraw:
            ...
            try:
                if 'DVB-T' in transponderdata['system']:
                    return '%s %s-%s %s %d MHz %s' % (transponderdata['system'],
                     tsid,
                     onid,
                ...
                if 'DVB-C' in transponderdata['system']:
                    return '%s %s-%s %d MHz %d %s %s' % (transponderdata['system'],
                     tsid,
                     onid,
                ...
                if 'ATSC' in transponderdata['system']:
                    return '%s %s-%s %d MHz %s' % (transponderdata['system'],
                     tsid,
                     onid,
                     transponderdata['frequency'] / 1000 + 0.5,
                     transponderdata['modulation'])
                return '%s %s-%s %d %s %d %s %s %s' % (transponderdata['system'],
                 tsid,
                 onid,
                 transponderdata['frequency'] / 1000 + 0.5,
